...
const MobileChatLayout: FC<MobileChatLayoutProps> = ({ friends, session, sidebarOptions, unseenRequestCount }) => {
  ...
  return (
    <div className='fixed bg-indigo-400 border-b  top-0 inset-x-0 py-2 px-4'>
      <div className='w-full flex justify-between items-center'>
        ...
        <Button onClick={() => setOpen(true)} className='bg-indigo-600 gap-4'>
              ...
              <div className='pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10'>
                <Transition.Child
                  ...
                  <Dialog.Panel className='pointer-events-auto w-screen max-w-md'>
                    <div className='flex h-full flex-col overflow-hidden bg-indigo-400 py-6 shadow-xl'>
                        ...
                        <nav className='flex flex-1 flex-col'>
                          <ul
                                ...
                                {sidebarOptions.map((option) => {
                                  ...
                                  return (
                                    <li key={option.name}>
                                      <Link
                                        href={option.href}
                                        className='text-white mb-4 mt-2 group flex gap-x-3 rounded-md text-sm leading-6 font-semibold'>
                            ...
                            <li className='-ml-6 mt-auto flex items-center'>
                              ...
                              <SignOutButton className='h-full bg-indigo-600 aspect-square' />
                            </li>
                          </ul>
                        </nav>
