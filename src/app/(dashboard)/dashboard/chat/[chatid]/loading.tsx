                ...
                <div className='grid grid-cols-12 gap-y-2'>
                  <div className='col-start-6 col-end-13 p-3 rounded-lg'>
                    <div className='flex items-center justify-start flex-row-reverse'>
                      <div className='relative h-10 w-10'>
                        <Skeleton width={40} baseColor='#7A96EA' height={40} borderRadius={999} />
                      </div>
                      <div className='relative mr-3 text-sm bg-indigo-100 text-black py-2 px-4 border border-gray-100 rounded-xl'>
                        <Skeleton className='ml-2' baseColor='#7A96EA' width={150} height={20} />
                      </div>
                    </div>
                  </div>
                  <div className='col-start-6 col-end-13 p-3 rounded-lg'>
                  ...
                  <div className='col-start-1 col-end-8 p-3 rounded-lg'>
                    <div className='flex flex-row items-center'>
                      <div className='relative h-10 w-10'>
                        <Skeleton width={40} height={40} baseColor='#7A96EA' borderRadius={999} />
                      </div>
                  ...
                  <div className='col-start-6 col-end-13 p-3 rounded-lg'>
                    <div className='flex items-center justify-start flex-row-reverse'>
                      ...
                      <div className='relative mr-3 text-sm bg-indigo-100 text-black py-2 px-4 border border-gray-100 rounded-xl'>
                        <Skeleton className='ml-2' width={150} baseColor='#7A96EA' height={20} />
                      </div>
                    </div>
                  </div>
                  <div className='col-start-1 col-end-8 p-3 rounded-lg'>
